...
export const LABS: Lab[] = [
  {
    ...
    experiments: [
      ...
      },
      {
        ...
        desc: "Align Sun, Moon & Earth — explore umbra, penumbra & eclipse types in interactive 3D",
        link: "/solar-eclipse",
        status: "available",
      ...
      },
      {
        ...
        desc: "Fire a laser at mirrors and glass — explore Snell's law, angles & total internal reflection",
        link: "/light-optics",
        status: "available",
      ...
      },
      {
        id: "lens-optics",
        icon: Focus,
        name: "Convex & Concave Lenses",
        desc: "Move an object toward a glass lens — watch real & virtual images form with live ray tracing",
        link: "/lens-optics",
        status: "available",
      ...
      },
      {
        ...
        desc: "Drag & drop cells, bulbs, switches & wires — series, parallel & bloom-lit filaments",
        link: "/electric-circuit",
        status: "available",
      ...
      },
      {
        ...
        desc: "Lever, pulley & inclined plane — lift loads with less force using mechanical advantage",
      ...
      },
      {
        id: "water-pressure",
        icon: Droplets,
        name: "Water Pressure Lab",
        desc: "Fill a transparent tank, drill holes at different depths & compare hydrostatic pressure jets",
        link: "/water-pressure",
        status: "available",
      ...
      },
      {
        id: "rocket-launch",
        icon: Rocket,
        name: "Satellite Launch Lab",
        desc: "Countdown, ignition, staging & orbit — watch a rocket deliver a satellite to space",
        link: "/rocket-launch",
        status: "available",
