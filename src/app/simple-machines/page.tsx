...
const SimpleMachinesScene = dynamic(
  () => import("@/components/simple-machines/SimpleMachinesScene"),
  { ssr: false },
);
    ...
    <div className="relative w-full h-[100dvh] overflow-hidden bg-black">
      ...
      <header className="absolute top-0 inset-x-0 z-30 flex items-start justify-between gap-2 px-3 pt-3 pb-2 sm:px-4 sm:pt-4 pointer-events-none">
        ...
        <div className="pointer-events-none flex flex-col items-center min-w-0 flex-1 px-1 sm:px-4 max-w-[min(100%,18rem)] sm:max-w-md mx-auto">
          ...
          <span className="mt-1.5 hidden min-[400px]:inline text-[9px] sm:text-[10px] font-semibold uppercase tracking-wider text-amber-400/90 glass-card px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full border border-amber-500/20">
            Interactive 3D · Ages 5–8
          </span>
        </div>
